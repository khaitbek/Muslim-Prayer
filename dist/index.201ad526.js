...
})({"iiiYj":[function(require,module,exports) {
"use strict";
...
servicesList.addEventListener("click", (evt)=>{
    ...
    if (targetElem.matches("[data-page]")) goToPage(targetElem.querySelector("#pageLink").href);
});
function goToPage(page) {
    window.location.href = page;
}

},{}]},["iiiYj","11CQn"], "11CQn", "parcelRequire371e")
