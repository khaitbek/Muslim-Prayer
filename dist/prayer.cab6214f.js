...
})({"3YbAL":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f4155b42cab6214f";
...
},{}],"6JHSI":[function(require,module,exports) {
// select DOM elements
...
async function getPrayerTimes(region, route) {
    ...
    if (Array.isArray(prayerTimesToJSON)) return renderPrayerTimes(prayerTimesToJSON, prayerTimesTable);
    renderPrayerTimes([
        prayerTimesToJSON
    ], prayerTimesTable);
...
function getDate(date) {
    let splitDate = date;
    if (splitDate.includes("T00")) splitDate = splitDate.split("T")[0];
    if (splitDate.includes(":")) splitDate = splitDate.split(",")[0];
    if (splitDate.includes("/")) splitDate = splitDate.split("/");
    else splitDate = splitDate.split("-");
...
},{}]},["3YbAL","6JHSI"], "6JHSI", "parcelRequire371e")

//# sourceMappingURL=prayer.cab6214f.js.map
